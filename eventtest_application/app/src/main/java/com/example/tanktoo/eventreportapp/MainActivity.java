...
public class MainActivity extends AppCompatActivity
    ...
    static final LatLng AARHUS = new LatLng(56.15, 10.22);
    private GoogleMap map;
    private MapFragment mapFragment;
    private MessageBus messageBus;
    private EventParser eventParser = new EventParser();
    private Map<String, Event> eventMap = new HashMap<String, Event>();
    //private List<Event> eventList = new ArrayList<Event>();         //TODO change to map with event id as key
    //private List<Event> userEventList = new ArrayList<Event>();     //TODO combine lists?
...
//            System.out.println("#### add event at lat " + event.getLatitude() + " lon " + event.getLongitude());
    ...
    //first fragment isnt set to stack to avoid blank page when emptying backstack
