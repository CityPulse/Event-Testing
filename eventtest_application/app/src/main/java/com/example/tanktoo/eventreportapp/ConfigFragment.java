...
public class ConfigFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        editText_host.setText(sharedPreferences.getString("mbus_host", "131.227.92.55"));

        EditText editText_port = (EditText) view.findViewById(R.id.config_frag_mbusPort_lbl_value);
        editText_port.setText(String.valueOf(sharedPreferences.getInt("mbus_port", 8007)));
    ...
    public void onClick(View arg0) {
        ...
        Snackbar.make(view, "Mbus config change to host " + sharedPreferences.getString("mbus_host", "131.227.92.55") + " and port " + sharedPreferences.getInt("mbus_port", 8007), Snackbar.LENGTH_LONG)
